...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.data2.setMinimumSize(QSize(120, 100))
        ...
        self.data3.setMinimumSize(QSize(120, 100))
        ...
        self.data4.setMinimumSize(QSize(120, 100))
        ...
        self.data5.setMinimumSize(QSize(120, 100))
        self.data5.setFont(font)
        ...
        self.data6.setMinimumSize(QSize(120, 100))
        self.data6.setFont(font)
        ...
        self.data7.setMinimumSize(QSize(120, 100))
        self.data7.setFont(font)
        ...
        self.data8.setMinimumSize(QSize(120, 100))
        self.data8.setFont(font)
        ...
        self.data9.setMinimumSize(QSize(120, 100))
        self.data9.setFont(font)
        ...
        self.serialport_select1.setFont(font1)
        ...
        font2.setBold(True)
        self.button_test.setFont(font2)
        ...
        self.parallelism_data.setFont(font3)
        ...
        self.identifier_data.setFont(font3)
